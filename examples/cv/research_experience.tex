    ...
    {Since 6/2020} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
      	...
      	\begin{itemize}\setlength{\parskip}{0pt}
      		\item automatic tilt-wing control -- video: \weblink{https://drive.google.com/file/d/17KuRJ5tZ2-2HdHv2\_iPJ2gaeiFHlKkkH/view?usp=sharing}{https://drive.google.com/file/d/17KuRJ5tZ2-2HdHv2\_iPJ2gaeiFHlKkkH/view?usp=sharing}
...
\cvexpentry
    ...
    {2014 - 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
		...
		\item Conducted performance optimization and developed automatic take-off, landing, and cruise control design for the \emph{AtlantikSolar UAV}, resulting in an \textbf{81.5 hour endurance world record} solar-powered flight for aircraft $<$50kg (2015) \weblink{http://www.atlantiksolar.ethz.ch/index.html\%3Fp=670.html}{http://www.atlantiksolar.ethz.ch/index.html\%3Fp=670.html} and 26 hour, fully autonomous, search-and-rescue payload equipped flight (2016) \weblink{http://www.atlantiksolar.ethz.ch/index.html\%3Fp=931.html}{http://www.atlantiksolar.ethz.ch/index.html\%3Fp=931.html}
      \end{cvitems}
    } % Description
    {} % website
    {true}
